...
export default function Special() {
  return (
    <div className="special" id="">
      <h3 className="special_title">더폴드만의 특별함</h3>
      <p className="special_description">
        <span>
          폴딩도어 하나에도 철학을 담았습니다. 견고함 속에 담긴 섬세한 움직임이 더폴드의 기준입니다.
        </span>
      </p>
      <ul className="lst">
        <li className="itm itm1">
          <div className="thumb">
